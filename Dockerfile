...
RUN apt-get -q update && apt-get -qqy install libpq-dev gcc git apt-transport-https ca-certificates curl gnupg-agent software-properties-common && rm -rf /var/lib/apt/lists/*
