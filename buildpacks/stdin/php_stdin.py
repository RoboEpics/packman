...
def find_php_main_file():
    for file in filter_files(r"\.php"):
        return file
...
class PHP8STDINBuildPack(BaseImage):
    ...
    def get_build_script_files(self):
        return {
            "/home/worker/buildpacks/stdin/php-tester.sh": "php-tester.sh"
        }

    def get_env(self):
        return [('ENTRY_FILE', find_php_main_file())]

    def get_command(self):
        """
        Tries to find the project's main method and it's package and returns a command with them to be run.
        """
        return "./php-tester.sh"
